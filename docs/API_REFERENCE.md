...
Aquí tienes la **Referencia de la API** completa en español, incluyendo todos los endpoints, ejemplos de código en su formato original y los códigos de respuesta HTTP.
